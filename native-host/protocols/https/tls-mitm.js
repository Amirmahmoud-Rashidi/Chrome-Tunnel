...
// Kept at native-host/ca/ (one level up from this file, which now lives
// in protocols/https/) so existing installs' already-trusted CA — the
// whole point of which is to avoid asking the user to re-trust a new one
// — keeps being found after this refactor.
